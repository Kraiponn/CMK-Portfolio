...
// @access  Public
const register = asyncHanler(async (req, res, next) => {
...
// @access  Public
const login = asyncHanler(async (req, res, next) => {
  const error = validationResult(req);
  validateBodyResults(error);
...
// @route   GET /api/v2021/auth/getprofile
// @access  Public
const getProfile = asyncHanler(async (req, res, next) => {
...
// @access  Private
const updateProfile = asyncHanler(async (req, res, next) => {
  const error = validationResult(req);
  validateBodyResults(error);
...
// @access  Private
const updatePassword = asyncHanler(async (req, res, next) => {
  const error = validationResult(req);
  validateBodyResults(error);
...
// @access  Public
const forgotPassword = asyncHanler(async (req, res, next) => {
  const error = validationResult(req);
  validateBodyResults(error);
...
// @access  Private
const removedAccount = asyncHanler(async (req, res, next) => {
