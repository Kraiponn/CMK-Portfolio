...
export const th = {
    ...
    drawerMenu: {
      ...
      account: {
        ...
        subMenu: {
          ...
          addUser: 'เพิ่มรายชื่อ',
        },
        selectedImageButton: 'เลือกรูป',
        editFormTitle: 'ข้อมูลส่วนตัว',
  ...
  authPage: {
    ...
    roleRequired: 'กรุณาระบุ สิทธิการเข้าถึง',
    sexRequired: 'กรุณาระบุ เพศ',
    ageRequired: 'กรุณาระบุ อายุ',
    ageValidNo: 'กรุณาระบุ อายุเป็นตัวเลข',
    mobileRequired: 'กรุณาระบุ หมายเลขโทรศัพท์',
    addressRequired: 'กรุณาระบุ ที่อยู่',
